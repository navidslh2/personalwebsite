...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-5 left-5 right-5 h-[60px]  px-5 md:px-10 flex items-center justify-between  border border-gray-800 bg-gray-700  rounded-xl shadow-[0_4px_30px_rgba(0,0,0,0.3)] z-20">
      <AlignCenterIcon
